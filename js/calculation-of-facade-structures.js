...
let material_construction = document.getElementById("material_construction");

// Список материалов стойки / ригеля
let material_construction_list = document.getElementById("material_construction_list");
...
// 	let option_material_construction_list = document.createElement('option');
// 	option_material_construction_list.innerHTML = key;
// 	material_construction_list.append(option_material_construction_list);
// }
...
function get_E_construction() {
	// Получить значение (наименование) материала
	let selected_material_construction = material_construction.value;
	
	if (selected_material_construction) {
		E.value = materials_const[selected_material_construction].E;
	} else {
		E.value = "";
	}
}
...
function get_γ_const() {
	...
	if (selected_material_construction) {
		γ_const.value = materials_const[selected_material_construction].γ;
	} else {
		γ_const.value = "";
	}
}
...
material_construction.onchange = () => {
	get_E_construction();
	get_γ_const();
};
